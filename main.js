(function(){
  ...
  function addFolder(){
        let rname = prompt("Enter Commitee's name");
        if(rname != null){
            rname = rname.trim();
        }
  ...
  function addTextFile(){
        let rname = prompt("Enter Member's name");
        if(rname != null){
            rname = rname.trim();
        }
        ...
        resources.push({
            ...
            fontFamily: "cursive",
            fontSize: 22,
            content: "                                                    Member's Details are shown."
        });
        saveToStorage();
  }
  
  function addAlbum(){
      let rname = prompt("Enter Dashboard's name");
      if(rname != null){
          rname = rname.trim();
      }
  ...
  function renameFolder(){
        let nrname = prompt("Enter Commitee's name");
        if(nrname != null){
            nrname = nrname.trim();
        }
  ...
  function renameTextFile(){
        let nrname = prompt("Enter Member's name");
        if(nrname != null){
            nrname = nrname.trim();
        }
  ...
  function renameAlbum(){
      let nrname = prompt("Enter 's name");
      if(nrname != null){
          nrname = nrname.trim();
      }
  ...
  function addPictureToAlbum(){
      ...
      //url image input liya
      let iurl = prompt("Enter an image of Member");
  
      //bug hai chota sa for empty input image url 
      //ager khali input daal liya to return ker de verna vacant picture space appear hoga.
      if(!iurl){
          return;
      }
      ...
      //and add kerne ke baad main function wali list of pictures mei 
      //add ker diya 
      img.addEventListener("click", showPictureInMain);
  
      //last mei picture list jo hai hamarai usmei current picture input wali add ker di append
      //ker di. 
  ...
  function showPictureInMain(){
      ...
      //jis picture ko view kerna hai click kerne per sirf usko pressed rakhna hai with border white
      //baki sabko change nahi kerna
  
      //iske liye sari picture list nikal li query selector all kerke.
         let divPictureList = divAppBody.querySelector(".picture-list");
         let imgs = divPictureList.querySelectorAll("img");
  
      //and jo picture list nikali usper loop lagaya sabki images[i] ke pressed attribut ko
      //false ker diya and jo current imgage hai this wali uska loop chalane ke  baad
      //pressed attribute true ker diya 
  ...
  function downloadNotepad(){
      ...
      //without parentNode jaise neeche likha hai data: ke baad aisa dena padega. 
  ...
  function uploadNotepad(){
      ...
      //ager file reader ke baad and add event listener se phle yani in dono ke  beech mei
      //kuch work hota like while loop for loop etc. then file upload kerne mei 
      //time ya buffer ajata isliye humne turant baad mei hi add event lsistener ker diya
